...
# Set hostname for CD4
echo -e "\e[1;34mSetting hostname to cd4-raspberry...\e[0m"
sudo hostnamectl set-hostname cd4-raspberry

# Update hosts file
echo -e "\e[1;33mUpdating /etc/hosts...\e[0m"
sudo bash -c 'cat > /etc/hosts' << EOF
127.0.0.1       localhost
127.0.1.1       cd4-raspberry
EOF
...
# Change directory to /home/oxi5
cd /home/oxi5 || { echo -e "\e[1;31mFailed to change directory to /home/oxi5\e[0m"; exit 1; }
...
sudo tmux new-session -d -s mav 'socat UDP4-DATAGRAM:192.168.22.161:14554 /dev/serial0,b115200,raw,echo=0'
...
#!/bin/bash
sudo tmux kill-session
sudo tmux new-session -d -s run '/usr/bin/python3 /home/oxi5/rpz/run.py'
...
(crontab -l 2>/dev/null; echo "@reboot /home/oxi5/run.sh") | crontab -

# Display success message
echo -e "\e[1;32mCD4 Setup completed successfully!\e[0m"
echo -e "\e[1;35mSystem will reboot in 5 seconds...\e[0m"

echo -e "\e[1;36mDo ssh into the CD4 using: ssh oxi5@cd4-raspberry\e[0m"
