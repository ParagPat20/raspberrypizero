...
echo "Setting hostname to cd2-raspberry..."
...
cd /home/oxi3 || { echo "Failed to change directory to /home/oxi3"; exit 1; }
...
echo "CD2 Setup completed successfully!"
echo "System will reboot in 5 seconds..."

echo "Do ssh into the CD2 using: ssh oxi3@cd2-raspberry"
