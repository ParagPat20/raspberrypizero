...
# Set hostname for MCU
echo -e "\e[1;34mSetting hostname to mcu-raspberry...\e[0m"
sudo hostnamectl set-hostname mcu-raspberry

# Update hosts file
echo -e "\e[1;33mUpdating /etc/hosts...\e[0m"
sudo bash -c 'cat > /etc/hosts' << EOF
127.0.0.1       localhost
127.0.1.1       mcu-raspberry
EOF
...
cd /home/oxi || { echo -e "\e[1;31mFailed to change directory to /home/oxi\e[0m"; exit 1; }
...
echo -e "\e[1;32mMCU Setup completed successfully!\e[0m"
echo -e "\e[1;35mSystem will reboot in 5 seconds...\e[0m"

echo -e "\e[1;36mDo ssh into the MCU using: ssh oxi@mcu-raspberry\e[0m"
